...
[ML Config](../stijns_mlops_project/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore stijns_mlops_project/databricks-resources/README.md
...
Follow the instructions in [stijns-mlops-project/databricks-resources/README.md](../stijns_mlops_project/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../stijns_mlops_project/databricks-resources/README.md)  to propose, test, and deploy
