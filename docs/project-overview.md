...
```
stijns-mlops-project         <- Root directory. Both monorepo and polyrepo are supported.
│
├── stijns_mlops_project       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
