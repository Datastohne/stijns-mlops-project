...
Opening a pull request will trigger a[workflow](../.github/workflows/stijns-mlops-project-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-stijns-mlops-project-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-stijns-mlops-project-model)
